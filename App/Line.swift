...
struct Line_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{ geometry in
            Line(data: ChartData(points: [12,-230,10,54]), frame: .constant(geometry.frame(in: .local)), touchLocation: .constant(CGPoint(x: 100, y: 12)), showIndicator: .constant(true), minDataValue: .constant(nil), maxDataValue: .constant(nil), gradient: GradientColor(start: Color("WhiteLine"), end: Color("WhiteLine")), linearGrad: LinearGradient(gradient: Gradient(colors: [Color("ShadowLine"), Color("DarkChart")]), startPoint: .bottom, endPoint: .top))
